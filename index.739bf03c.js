...
let hasSubscribed = false;
openModal();
const modal = new (0, _bootstrapNativeDefault.default).Modal("#myModal", {
    backdrop: "static",
...
myModal.addEventListener("hide.bs.modal", openModal);
...
/*!
  ...
  */ /** @type {Record<string, any>} */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
 ...
 */ function offcanvasDismissHandler(e) {
    ...
    /* istanbul ignore else */ if (!(selection && selection.toString().length) && (!element.contains(target) && backdrop && /* istanbul ignore next */ (!trigger || triggers.includes(target)) || offCanvasDismiss && offCanvasDismiss.contains(target))) {
